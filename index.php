...
<body>
    ...
    <form action="" method="post">
        <div class="uk-margin-xlarge-left ">
            ...
            <br>
            <br>
            <input type="submit" name="submit" class="uk-button uk-button-default uk-text-primary">
            <h1 class="uk-text-primary">Results</h1>
    ...
    <a href="about.php" class="uk-margin-xlarge-left uk-button-text uk-text-decoration-none uk-text-primary uk-margin-small-bottom" >What is Unix TimeStamp?</a>
